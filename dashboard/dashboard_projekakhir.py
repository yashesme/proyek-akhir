...
# Load data
hour_df = pd.read_csv("https://raw.githubusercontent.com/yashesme/proyekanalisisdata/main/hour.csv")
day_df = pd.read_csv("https://raw.githubusercontent.com/yashesme/proyekanalisisdata/main/day.csv")
